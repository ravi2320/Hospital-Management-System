		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<c:if test="${ empty patientObj }">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="appointmnet.jsp">APPOINTMENT</a></li>
				...
				<c:if test="${ not empty patientObj }">
					...
					<div class="dropdown">
						<button class="btn btn-success dropdown-toggle" type="button"
							...
							aria-expanded="false"><i class="fas fa-user-circle"></i>${patientObj.getPname()}</button>
						<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
							<li><a class="dropdown-item" href="change_password.jsp">Change Password</a></li>
							<li><a class="dropdown-item" href="PatientLogoutServlet">Logout</a></li>
						</ul>
					</div>
				</c:if>
			</ul>
